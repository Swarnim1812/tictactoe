...
const TicTacToe = ()=>{
  ...
  const checkwin=()=>{
    ...
    else if(data[0]===data[3] && data[3]===data[6] && data[6]!=="") won(data[2]);
    else if(data[1]===data[4] && data[4]===data[7] && data[7]!=="") won(data[6]);
    else if(data[2]===data[5] && data[5]===data[8] && data[8]!=="") won(data[7]);
  ...
  const won =(winner)=>{
    ...
    else titleRef.current.innerHTML=`Winner : <img src =${circle_icon}>`
  }
